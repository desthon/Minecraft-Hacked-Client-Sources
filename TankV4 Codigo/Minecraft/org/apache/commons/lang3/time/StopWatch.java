...
public class StopWatch {
   ...
   private static enum SplitState {
      ...
      private static final StopWatch.SplitState[] $VALUES = new StopWatch.SplitState[]{SPLIT, UNSPLIT};
   }
   ...
   private static enum State {
      ...
      private static final StopWatch.State[] $VALUES = new StopWatch.State[]{UNSTARTED, RUNNING, STOPPED, SUSPENDED};
