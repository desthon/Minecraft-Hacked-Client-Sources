...
public final class EXTShaderImageLoadStore {
   ...
   public static void glBindImageTextureEXT(int var0, int var1, int var2, boolean var3, int var4, int var5, int var6) {
      ContextCapabilities var7 = GLContext.getCapabilities();
      long var8 = var7.glBindImageTextureEXT;
      BufferChecks.checkFunctionAddress(var8);
      nglBindImageTextureEXT(var0, var1, var2, var3, var4, var5, var6, var8);
   }

   static native void nglBindImageTextureEXT(int var0, int var1, int var2, boolean var3, int var4, int var5, int var6, long var7);

   public static void glMemoryBarrierEXT(int var0) {
      ContextCapabilities var1 = GLContext.getCapabilities();
      long var2 = var1.glMemoryBarrierEXT;
      BufferChecks.checkFunctionAddress(var2);
      nglMemoryBarrierEXT(var0, var2);
   }
