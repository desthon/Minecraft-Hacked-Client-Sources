...
public final class NVBlendEquationAdvanced {
   ...
   public static void glBlendParameteriNV(int var0, int var1) {
      ContextCapabilities var2 = GLContext.getCapabilities();
      long var3 = var2.glBlendParameteriNV;
      BufferChecks.checkFunctionAddress(var3);
      nglBlendParameteriNV(var0, var1, var3);
   }
   ...
   public static void glBlendBarrierNV() {
      ...
      long var1 = var0.glBlendBarrierNV;
      BufferChecks.checkFunctionAddress(var1);
      nglBlendBarrierNV(var1);
   }
