...
public final class RenderTexture {
   ...
   public RenderTexture(boolean var1, boolean var2, boolean var3, boolean var4, int var5, int var6) {
      if (var1 && var2) {
         ...
         if (var3) {
            this.pixelFormatCaps.put(var4 ? 8356 : 8355);
            this.pixelFormatCaps.put(1);
         ...
         this.pBufferAttribs.put(var5);
         if (var6 != 0) {
            this.pBufferAttribs.put(8308);
            this.pBufferAttribs.put(var6);
         }
