...
public final class EFX10 {
   ...
   public static void alGenAuxiliaryEffectSlots(IntBuffer var0) {
      BufferChecks.checkDirect(var0);
      nalGenAuxiliaryEffectSlots(var0.remaining(), MemoryUtil.getAddress(var0));
   }

   static native void nalGenAuxiliaryEffectSlots(int var0, long var1);

   public static int alGenAuxiliaryEffectSlots() {
      int var0 = nalGenAuxiliaryEffectSlots2(1);
      return var0;
   }

   static native int nalGenAuxiliaryEffectSlots2(int var0);

   public static void alDeleteAuxiliaryEffectSlots(IntBuffer var0) {
      BufferChecks.checkDirect(var0);
      nalDeleteAuxiliaryEffectSlots(var0.remaining(), MemoryUtil.getAddress(var0));
   }

   static native void nalDeleteAuxiliaryEffectSlots(int var0, long var1);

   public static void alDeleteAuxiliaryEffectSlots(int var0) {
      nalDeleteAuxiliaryEffectSlots2(1, var0);
   }
   ...
   public static boolean alIsAuxiliaryEffectSlot(int var0) {
      boolean var1 = nalIsAuxiliaryEffectSlot(var0);
      return var1;
   }

   static native boolean nalIsAuxiliaryEffectSlot(int var0);

   public static void alAuxiliaryEffectSloti(int var0, int var1, int var2) {
      nalAuxiliaryEffectSloti(var0, var1, var2);
   }
   ...
   public static void alAuxiliaryEffectSlot(int var0, int var1, IntBuffer var2) {
      ...
      nalAuxiliaryEffectSlotiv(var0, var1, MemoryUtil.getAddress(var2));
   }
   ...
   public static void alAuxiliaryEffectSlotf(int var0, int var1, float var2) {
      nalAuxiliaryEffectSlotf(var0, var1, var2);
   }
   ...
   public static void alAuxiliaryEffectSlot(int var0, int var1, FloatBuffer var2) {
      ...
      nalAuxiliaryEffectSlotfv(var0, var1, MemoryUtil.getAddress(var2));
   }
   ...
   public static int alGetAuxiliaryEffectSloti(int var0, int var1) {
      int var2 = nalGetAuxiliaryEffectSloti(var0, var1);
      return var2;
   }
   ...
   public static void alGetAuxiliaryEffectSlot(int var0, int var1, IntBuffer var2) {
      BufferChecks.checkBuffer((IntBuffer)var2, 1);
      nalGetAuxiliaryEffectSlotiv(var0, var1, MemoryUtil.getAddress(var2));
   }
   ...
   public static float alGetAuxiliaryEffectSlotf(int var0, int var1) {
      float var2 = nalGetAuxiliaryEffectSlotf(var0, var1);
      return var2;
   }
   ...
   public static void alGetAuxiliaryEffectSlot(int var0, int var1, FloatBuffer var2) {
      BufferChecks.checkBuffer((FloatBuffer)var2, 1);
      nalGetAuxiliaryEffectSlotfv(var0, var1, MemoryUtil.getAddress(var2));
   }

   static native void nalGetAuxiliaryEffectSlotfv(int var0, int var1, long var2);

   public static void alGenEffects(IntBuffer var0) {
      BufferChecks.checkDirect(var0);
      nalGenEffects(var0.remaining(), MemoryUtil.getAddress(var0));
   }

   static native void nalGenEffects(int var0, long var1);

   public static int alGenEffects() {
      int var0 = nalGenEffects2(1);
      return var0;
   }

   static native int nalGenEffects2(int var0);

   public static void alDeleteEffects(IntBuffer var0) {
      BufferChecks.checkDirect(var0);
      nalDeleteEffects(var0.remaining(), MemoryUtil.getAddress(var0));
   }

   static native void nalDeleteEffects(int var0, long var1);

   public static void alDeleteEffects(int var0) {
      nalDeleteEffects2(1, var0);
   }

   static native void nalDeleteEffects2(int var0, int var1);

   public static boolean alIsEffect(int var0) {
      boolean var1 = nalIsEffect(var0);
      return var1;
   }

   static native boolean nalIsEffect(int var0);

   public static void alEffecti(int var0, int var1, int var2) {
      nalEffecti(var0, var1, var2);
   }
   ...
   public static void alEffect(int var0, int var1, IntBuffer var2) {
      BufferChecks.checkBuffer((IntBuffer)var2, 1);
      nalEffectiv(var0, var1, MemoryUtil.getAddress(var2));
   }

   static native void nalEffectiv(int var0, int var1, long var2);

   public static void alEffectf(int var0, int var1, float var2) {
      nalEffectf(var0, var1, var2);
   }
   ...
   public static void alEffect(int var0, int var1, FloatBuffer var2) {
      BufferChecks.checkBuffer((FloatBuffer)var2, 1);
      nalEffectfv(var0, var1, MemoryUtil.getAddress(var2));
   }

   static native void nalEffectfv(int var0, int var1, long var2);

   public static int alGetEffecti(int var0, int var1) {
      int var2 = nalGetEffecti(var0, var1);
      return var2;
   }
   ...
   public static void alGetEffect(int var0, int var1, IntBuffer var2) {
      BufferChecks.checkBuffer((IntBuffer)var2, 1);
      nalGetEffectiv(var0, var1, MemoryUtil.getAddress(var2));
   }

   static native void nalGetEffectiv(int var0, int var1, long var2);

   public static float alGetEffectf(int var0, int var1) {
      float var2 = nalGetEffectf(var0, var1);
      return var2;
   }
   ...
   public static void alGetEffect(int var0, int var1, FloatBuffer var2) {
      BufferChecks.checkBuffer((FloatBuffer)var2, 1);
      nalGetEffectfv(var0, var1, MemoryUtil.getAddress(var2));
   }

   static native void nalGetEffectfv(int var0, int var1, long var2);

   public static void alGenFilters(IntBuffer var0) {
      BufferChecks.checkDirect(var0);
      nalGenFilters(var0.remaining(), MemoryUtil.getAddress(var0));
   }

   static native void nalGenFilters(int var0, long var1);

   public static int alGenFilters() {
      int var0 = nalGenFilters2(1);
      return var0;
   }

   static native int nalGenFilters2(int var0);

   public static void alDeleteFilters(IntBuffer var0) {
      BufferChecks.checkDirect(var0);
      nalDeleteFilters(var0.remaining(), MemoryUtil.getAddress(var0));
   }

   static native void nalDeleteFilters(int var0, long var1);

   public static void alDeleteFilters(int var0) {
      nalDeleteFilters2(1, var0);
   }

   static native void nalDeleteFilters2(int var0, int var1);

   public static boolean alIsFilter(int var0) {
      boolean var1 = nalIsFilter(var0);
      return var1;
   }

   static native boolean nalIsFilter(int var0);

   public static void alFilteri(int var0, int var1, int var2) {
      nalFilteri(var0, var1, var2);
   }
   ...
   public static void alFilter(int var0, int var1, IntBuffer var2) {
      BufferChecks.checkBuffer((IntBuffer)var2, 1);
      nalFilteriv(var0, var1, MemoryUtil.getAddress(var2));
   }

   static native void nalFilteriv(int var0, int var1, long var2);

   public static void alFilterf(int var0, int var1, float var2) {
      nalFilterf(var0, var1, var2);
   }
   ...
   public static void alGetFilter(int var0, int var1, IntBuffer var2) {
      BufferChecks.checkBuffer((IntBuffer)var2, 1);
      nalGetFilteriv(var0, var1, MemoryUtil.getAddress(var2));
   }

   static native void nalGetFilteriv(int var0, int var1, long var2);

   public static float alGetFilterf(int var0, int var1) {
      float var2 = nalGetFilterf(var0, var1);
      return var2;
   }
   ...
   public static void alGetFilter(int var0, int var1, FloatBuffer var2) {
      BufferChecks.checkBuffer((FloatBuffer)var2, 1);
      nalGetFilterfv(var0, var1, MemoryUtil.getAddress(var2));
   }
