...
public class RealmsConfigureWorldScreen extends RealmsScreen implements RealmsConfirmResultListener {
   ...
   public RealmsConfigureWorldScreen(RealmsScreen var1, long var2) {
   ...
   public void init() {
      ...
      this.buttonsClear();
      this.buttonsAdd(this.settingsButton = newButton(5, this.column2_x, this.row(6), this.column_width, 20, getLocalizedString("mco.configure.world.buttons.edit")));
      ...
      this.invitedSelectionList = new RealmsConfigureWorldScreen.InvitedSelectionList(this);
   ...
   private void fetchOps() {
      (new Thread(this) {
         ...
         public void run() {
            ...
            try {
               RealmsConfigureWorldScreen.access$002(this.this$0, var1.getOpsFor(RealmsConfigureWorldScreen.access$100(this.this$0)).ops);
            } catch (RealmsServiceException var3) {
               RealmsConfigureWorldScreen.access$200().error("Couldn't fetch ops");
            } catch (Exception var4) {
               RealmsConfigureWorldScreen.access$200().error("Couldn't parse response of fetching ops");
            }
   ...
   private void getOwnWorld(long var1) {
      (new Thread(this, var1) {
         ...
         public void run() {
            ...
            try {
               RealmsConfigureWorldScreen.access$302(this.this$0, var1.getOwnWorld(this.val$worldId));
               RealmsConfigureWorldScreen.access$400(this.this$0);
               RealmsConfigureWorldScreen.access$500(this.this$0).active(!RealmsConfigureWorldScreen.access$300(this.this$0).expired);
               RealmsConfigureWorldScreen.access$600(this.this$0).active(!RealmsConfigureWorldScreen.access$300(this.this$0).expired);
               RealmsConfigureWorldScreen.access$700(this.this$0).active(true);
               RealmsConfigureWorldScreen.access$800(this.this$0).active(true);
               RealmsConfigureWorldScreen.access$900(this.this$0).active(true);
               boolean var2 = RealmsConfigureWorldScreen.access$300(this.this$0).worldType.equals(RealmsServer.WorldType.MINIGAME);
               if (var2) {
                  RealmsConfigureWorldScreen.access$600(this.this$0).msg(RealmsScreen.getLocalizedString("mco.configure.world.buttons.modifyMiniGame"));
                  RealmsConfigureWorldScreen.access$500(this.this$0).active(false);
                  RealmsConfigureWorldScreen.access$900(this.this$0).active(false);
               }
            } catch (RealmsServiceException var3) {
               RealmsConfigureWorldScreen.access$200().error("Couldn't get own world");
            } catch (IOException var4) {
               RealmsConfigureWorldScreen.access$200().error("Couldn't parse response getting own world");
            }
   ...
   static Set access$002(RealmsConfigureWorldScreen var0, Set var1) {
      return var0.ops = var1;
   }

   static long access$100(RealmsConfigureWorldScreen var0) {
   ...
   static RealmsServer access$302(RealmsConfigureWorldScreen var0, RealmsServer var1) {
      return var0.serverData = var1;
   }

   static void access$400(RealmsConfigureWorldScreen var0) {
      var0.fetchOps();
   }

   static RealmsServer access$300(RealmsConfigureWorldScreen var0) {
      return var0.serverData;
   }

   static RealmsButton access$500(RealmsConfigureWorldScreen var0) {
      return var0.settingsButton;
   }

   static RealmsButton access$600(RealmsConfigureWorldScreen var0) {
      return var0.minigameButton;
   }

   static RealmsButton access$700(RealmsConfigureWorldScreen var0) {
      return var0.subscriptionButton;
   }

   static RealmsButton access$800(RealmsConfigureWorldScreen var0) {
      return var0.activityButton;
   }

   static RealmsButton access$900(RealmsConfigureWorldScreen var0) {
      return var0.editWorldButton;
   }

   static int access$1000(RealmsConfigureWorldScreen var0) {
      return var0.column_width;
   }

   static int access$1100(RealmsConfigureWorldScreen var0, int var1) {
      return var0.row(var1);
   }

   static int access$1200(RealmsConfigureWorldScreen var0) {
      return var0.column1_x;
   }

   static Set access$000(RealmsConfigureWorldScreen var0) {
      return var0.ops;
   }

   static void access$1300(RealmsConfigureWorldScreen var0, int var1) {
      var0.deop(var1);
   }

   static void access$1400(RealmsConfigureWorldScreen var0, int var1) {
      var0.op(var1);
   }

   static void access$1500(RealmsConfigureWorldScreen var0, int var1) {
      var0.uninvite(var1);
   }

   static void access$1600(RealmsConfigureWorldScreen var0, int var1, int var2, int var3, int var4) {
      var0.drawOpped(var1, var2, var3, var4);
   }

   static void access$1700(RealmsConfigureWorldScreen var0, int var1, int var2, int var3, int var4) {
      var0.drawNormal(var1, var2, var3, var4);
   }

   static void access$1800(RealmsConfigureWorldScreen var0, int var1, int var2, int var3, int var4) {
   ...
   private class InvitedSelectionList extends RealmsClickableScrolledSelectionList {
      ...
      public InvitedSelectionList(RealmsConfigureWorldScreen var1) {
         super(RealmsConfigureWorldScreen.access$1000(var1) + 10, RealmsConfigureWorldScreen.access$1100(var1, 10), RealmsConfigureWorldScreen.access$1100(var1, 2), RealmsConfigureWorldScreen.access$1100(var1, 10), 13);
         this.this$0 = var1;
      }
      ...
      public void customMouseEvent(int var1, int var2, int var3, float var4, int var5) {
         if (Mouse.isButtonDown(0) && this.ym() >= var1 && this.ym() <= var2) {
            int var6 = RealmsConfigureWorldScreen.access$1200(this.this$0);
            int var7 = RealmsConfigureWorldScreen.access$1200(this.this$0) + RealmsConfigureWorldScreen.access$1000(this.this$0);
      ...
      public void itemClicked(int var1, int var2, int var3, int var4, int var5) {
         int var6 = RealmsConfigureWorldScreen.access$1200(this.this$0) + RealmsConfigureWorldScreen.access$1000(this.this$0) - 22;
         ...
         if (var3 >= var8 && var3 <= var8 + 9 && var4 >= var9 && var4 <= var9 + 9) {
            if (var2 >= 0 && var2 < RealmsConfigureWorldScreen.access$300(this.this$0).players.size()) {
               String var10 = ((PlayerInfo)RealmsConfigureWorldScreen.access$300(this.this$0).players.get(var2)).getName();
               if (RealmsConfigureWorldScreen.access$000(this.this$0) != null) {
                  if (RealmsConfigureWorldScreen.access$000(this.this$0).contains(var10)) {
                     RealmsConfigureWorldScreen.access$1300(this.this$0, var2);
                  } else {
                     RealmsConfigureWorldScreen.access$1400(this.this$0, var2);
                  }
               }
            }
         } else if (var3 >= var6 && var3 <= var6 + 9 && var4 >= var7 && var4 <= var7 + 9 && var2 >= 0 && var2 < RealmsConfigureWorldScreen.access$300(this.this$0).players.size()) {
            RealmsConfigureWorldScreen.access$1500(this.this$0, var2);
         }
      ...
      public int getScrollbarPosition() {
         return RealmsConfigureWorldScreen.access$1200(this.this$0) + this.width() - 5;
      }

      public int getItemCount() {
         return RealmsConfigureWorldScreen.access$300(this.this$0) == null ? 1 : RealmsConfigureWorldScreen.access$300(this.this$0).players.size();
      }
      ...
      protected void renderItem(int var1, int var2, int var3, int var4, Tezzelator var5, int var6, int var7) {
         if (RealmsConfigureWorldScreen.access$300(this.this$0) != null) {
            if (var1 < RealmsConfigureWorldScreen.access$300(this.this$0).players.size()) {
      ...
      private void renderInvitedItem(int var1, int var2, int var3, int var4) {
         PlayerInfo var5 = (PlayerInfo)RealmsConfigureWorldScreen.access$300(this.this$0).players.get(var1);
         this.this$0.drawString(var5.getName(), RealmsConfigureWorldScreen.access$1200(this.this$0) + 3 + 12, var3 + 1, 16777215);
         if (RealmsConfigureWorldScreen.access$000(this.this$0) != null && RealmsConfigureWorldScreen.access$000(this.this$0).contains(var5.getName())) {
            RealmsConfigureWorldScreen.access$1600(this.this$0, RealmsConfigureWorldScreen.access$1200(this.this$0) + RealmsConfigureWorldScreen.access$1000(this.this$0) - 10, var3 + 1, this.xm(), this.ym());
         } else {
            RealmsConfigureWorldScreen.access$1700(this.this$0, RealmsConfigureWorldScreen.access$1200(this.this$0) + RealmsConfigureWorldScreen.access$1000(this.this$0) - 10, var3 + 1, this.xm(), this.ym());
         }

         RealmsConfigureWorldScreen.access$1800(this.this$0, RealmsConfigureWorldScreen.access$1200(this.this$0) + RealmsConfigureWorldScreen.access$1000(this.this$0) - 22, var3 + 2, this.xm(), this.ym());
         RealmsScreen.bindFace(var5.getUuid(), var5.getName());
         GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
         RealmsScreen.blit(RealmsConfigureWorldScreen.access$1200(this.this$0) + 2 + 2, var3 + 1, 8.0F, 8.0F, 8, 8, 8, 8, 64.0F, 64.0F);
         RealmsScreen.blit(RealmsConfigureWorldScreen.access$1200(this.this$0) + 2 + 2, var3 + 1, 40.0F, 8.0F, 8, 8, 8, 8, 64.0F, 64.0F);
      }
   }
}
