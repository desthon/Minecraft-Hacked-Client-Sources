...
class RBBIRuleParseTable {
   ...
   static class RBBIRuleTableElement {
      ...
      RBBIRuleTableElement(short var1, int var2, int var3, int var4, boolean var5, String var6) {
         this.fAction = var1;
         this.fCharClass = (short)var2;
         this.fNextState = (short)var3;
         this.fPushState = (short)var4;
         this.fNextChar = var5;
         this.fStateName = var6;
      }
   }
}
