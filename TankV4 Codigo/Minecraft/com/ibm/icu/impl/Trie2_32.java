...
public class Trie2_32 extends Trie2 {
   ...
   public static Trie2_32 createFromSerialized(InputStream var0) throws IOException {
      return (Trie2_32)Trie2.createFromSerialized(var0);
   }
   ...
   public final int get(int var1) {
      if (var1 >= 0) {
         ...
         if (var1 <= 1114111) {
            var2 = this.data32[this.highValueIndex];
            return var2;
         }
      }
   ...
   public int serialize(OutputStream var1) throws IOException {
      ...
      for(int var4 = 0; var4 < this.dataLength; ++var4) {
         var2.writeInt(this.data32[var4]);
      }

      var5 += this.dataLength * 4;
      return var5;
   }
      ...
      while(var4 < var2) {
         ...
         if (var4 < 55296 || var4 > 56319 && var4 <= 65535) {
            ...
            if (var4 >= this.highStart) {
               if (var3 == this.data32[this.highValueIndex]) {
                  var4 = var2;
               }
               break;
            }
