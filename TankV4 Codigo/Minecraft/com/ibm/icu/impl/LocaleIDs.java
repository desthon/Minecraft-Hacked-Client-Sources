...
public class LocaleIDs {
   ...
   public static String getISO3Country(String var0) {
      int var1 = findIndex(_countries, var0);
      if (var1 >= 0) {
         return _countries3[var1];
      } else {
         var1 = findIndex(_obsoleteCountries, var0);
         return var1 >= 0 ? _obsoleteCountries3[var1] : "";
      }
   }

   public static String getISO3Language(String var0) {
      int var1 = findIndex(_languages, var0);
      if (var1 >= 0) {
         return _languages3[var1];
      } else {
         var1 = findIndex(_obsoleteLanguages, var0);
         return var1 >= 0 ? _obsoleteLanguages3[var1] : "";
      }
   }

   public static String threeToTwoLetterLanguage(String var0) {
      int var1 = findIndex(_languages3, var0);
      if (var1 >= 0) {
         return _languages[var1];
      } else {
         var1 = findIndex(_obsoleteLanguages3, var0);
         return var1 >= 0 ? _obsoleteLanguages[var1] : null;
      }
   }

   public static String threeToTwoLetterRegion(String var0) {
      int var1 = findIndex(_countries3, var0);
      if (var1 >= 0) {
         return _countries[var1];
      } else {
         var1 = findIndex(_obsoleteCountries3, var0);
         return var1 >= 0 ? _obsoleteCountries[var1] : null;
      }
   }

   private static int findIndex(String[] var0, String var1) {
   ...
   public static String getCurrentCountryID(String var0) {
      int var1 = findIndex(_deprecatedCountries, var0);
      return var1 >= 0 ? _replacementCountries[var1] : var0;
   }

   public static String getCurrentLanguageID(String var0) {
      int var1 = findIndex(_obsoleteLanguages, var0);
      return var1 >= 0 ? _replacementLanguages[var1] : var0;
   }
}
