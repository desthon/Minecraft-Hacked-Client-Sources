...
public class HebrewHoliday extends Holiday {
   ...
   public HebrewHoliday(int var1, int var2, String var3) {
      this(var1, var2, 1, var3);
   }

   public HebrewHoliday(int var1, int var2, int var3, String var4) {
      super(var4, new SimpleDateRule(var1, var2, gCalendar));
   }
}
