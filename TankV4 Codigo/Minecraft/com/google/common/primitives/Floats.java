...
public final class Floats {
   ...
   private static class FloatArrayAsList extends AbstractList implements RandomAccess, Serializable {
      ...
      public boolean contains(Object var1) {
         return var1 instanceof Float && Floats.access$000(this.array, (Float)var1, this.start, this.end) != -1;
      }

      public int indexOf(Object var1) {
         if (var1 instanceof Float) {
            int var2 = Floats.access$000(this.array, (Float)var1, this.start, this.end);
            if (var2 >= 0) {
      ...
      public int lastIndexOf(Object var1) {
         if (var1 instanceof Float) {
            int var2 = Floats.access$100(this.array, (Float)var1, this.start, this.end);
            if (var2 >= 0) {
               return var2 - this.start;
            }
         }
   ...
   private static enum LexicographicalComparator implements Comparator {
      ...
      private static final Floats.LexicographicalComparator[] $VALUES = new Floats.LexicographicalComparator[]{INSTANCE};

      public int compare(float[] var1, float[] var2) {
         int var3 = Math.min(var1.length, var2.length);

         for(int var4 = 0; var4 < var3; ++var4) {
            int var5 = Floats.compare(var1[var4], var2[var4]);
            if (var5 != 0) {
               return var5;
            }
         }
